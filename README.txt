...
1) POST /movies
     POST:  https://guarded-thicket-42470.herokuapp.com/api/movies
      body: 
      {
...
2) GET /movies
    GET: https://guarded-thicket-42470.herokuapp.com/api/movies
    I add sort by desc by title.(Z-A)
    I decide to show just Title, Year, Runtime, Genre.
    
3)POST /comments
  POST: https://guarded-thicket-42470.herokuapp.com/api/comments
  body:
  {
	"id": "5b9d34ebb61d0f00155bee07",
	"yourComment": "See u soon"
  }
4)GET /comments
   GET: https://guarded-thicket-42470.herokuapp.com/api/comments/5b9d34ebb61d0f00155bee07

if u want use localhost and run it on your pc you have to set variable in system, just type this in terminal in project folder:

export kamil_db=localhost:3000
npm i
mongod
npm start
